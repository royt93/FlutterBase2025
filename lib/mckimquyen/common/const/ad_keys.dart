...
class AdKey {
  ...
  // (`GADApplicationIdentifier`). As of 2026-07-19 both hold the real
  // production App ID (`ca-app-pub-3004713799155145~9488250427`).
  //
  // The ad unit IDs below are still Google's public test IDs — safe to ship
