...
import 'package:tracuuphatnguoi/mckimquyen/lib/daily_local_notification/repositories/reminder_repository.dart';
import 'package:tracuuphatnguoi/mckimquyen/lib/daily_local_notification/repositories/shared_prefs_repository.dart';
import 'package:tracuuphatnguoi/mckimquyen/lib/daily_local_notification/ui/daily_local_notification_widget.dart';
...
class _DailyLocalNotificationsState extends State<DailyLocalNotifications> {
  ...
  Future<ReminderSettingsProvider> init() async {
    ...
    // debugPrint("4");
    // debugPrint("reminderSettingsProvider $reminderSettingsProvider");
