...
class SharedPreferencesUtil {
  ...
  static void resetAllData() async {
    ...
    await prefs.clear();
    // debugPrint("valueTimestampDismissBottomSheetNotification $valueTimestampDismissBottomSheetNotification");
    // debugPrint("valueHasConfigNotificationForAndroidBelow33 $valueHasConfigNotificationForAndroidBelow33");
